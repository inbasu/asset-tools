            ...
            <Toolbar variant="dense" sx={{ flexGrow: 1, padding: 0, height: '4vh' }}>
                <Link to="/">
                    <img
                        src={logo}
                        alt="Metro"
                        style={{ height: '4vh', maxHeight: '4vh', position: 'absolute', left: '0vw', top: '0' }}
                    />
                    <Typography
                        display="block"
                        variant="caption"
                ...
                <div
                    onClick={handleClick}
                    style={{ height: '5vh', position: 'absolute', right: '0.3vw', top: '0', textAlign: 'right' }}
                >
                ...
                >
                    <MenuItem>
                        <Tooltip
                            title={<div style={{ whiteSpace: 'pre-line' }}>{user.roles.join('\n')}</div>}
                            placement="left-start"
                        >
                            <Typography variant="caption" textAlign="right" fontSize={'1.2vh'}>
                                Roles
                            </Typography>
                        </Tooltip>
                    </MenuItem>
